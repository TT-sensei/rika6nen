(() => {
  ...
  const initial = () => ({ covered:false, bottomGap:false, topGap:false, lit:false, time:0, oxygen:21, co2:0.04, beforeOxygen:21, beforeCo2:0.04, flow:false, inside:false, speed:1, sample:"after", lime:false, shaken:false });
  ...
  function scene(s, m) {
    ...
    const jar = s.covered ? `<g data-action="jar" class="jar"><path d="M270 100h360v300q0 35-35 35H305q-35 0-35-35z" fill="#b9e0e8" fill-opacity=".28" stroke="#518696" stroke-width="7"/><path d="M270 100h360" stroke="#518696" stroke-width="9"/><text x="450" y="440" text-anchor="middle" class="scene-label">集気びん</text></g>` : "";
