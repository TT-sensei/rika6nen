(() => {
  ...
  const initial = () => ({ covered:false, jarX:700, bottomGap:false, topGap:false, lit:false, time:0, oxygen:21, co2:0.04, beforeOxygen:21, beforeCo2:0.04, flow:false, inside:false, speed:1, sample:"after", lime:false, oxygenTest:false, shaken:false });
