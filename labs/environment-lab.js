(() => {
  ...
  const spec = {    environment:{time:true,hint:"一つの生物や水を変えると、ほかへ変化が広がります。",model:"実際の自然を、食べる関係が見えるように単純化したモデルです。",controls:[range("plants","植物",5,95,55),range("insects","昆虫",1,70,20),range("small","小動物",1,40,10),range("birds","鳥",1,25,6),range("water","水の量",10,100,75,"%")],presets:[["つり合った草地",{plants:55,insects:20,small:10,birds:6,water:75}],["昆虫が減る",{plants:55,insects:3,small:10,birds:6,water:75}],["水が少ない",{plants:55,insects:20,small:10,birds:6,water:20}]]}};
