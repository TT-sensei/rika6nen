(() => {
  ...
  ].forEach(([id,title,unit,icon,summary,accent]) => MANIFESTS[id] = {id,title,unit,icon,summary,accent,script:id === "burning" ? "labs/burning-lab.js" : id === "solutions" ? "labs/solutions-lab.js" : id === "electricity" ? "labs/electricity-lab.js" : "labs/extra-labs.js",ready:true});
  const FUTURE = [
